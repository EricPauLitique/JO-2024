 ...
 * @author lpivet
 */
public class PanelAfficherEpreuve extends JPanel {
	...
	// modifie)
	public PanelAfficherEpreuve(PanelGrille grille) {
		...
		PanelBandeau.setGrilleEpreuve(grilleEpreuve); // Permet d'enregistrer la nouvelle grille des épreuves de façon
																									// static
